...
class Game {
	...
	public class Player extends Thread {
		...
		Player opponent;
		int x, y, coins;
		// Time in which Game will End in Milliseconds.
		long time = 30000;
					...
					if (response.startsWith("POS")) {
						...
						if ((endTime - startTime) > time) {
							if (coins == opponent.coins) {
								...
								output.println("END YOU WON! Your opponent has " + opponent.coins
										+ " coins and you have " + coins + "!");
								opponent.output.println("END YOU LOST! Your opponent has " + coins
										+ " coins and you have " + opponent.coins + "!");
							} else {
								output.println("END YOU LOST! Your opponent has " + opponent.coins
										+ " coins and you have " + coins + "!");
								opponent.output.println("END YOU WON! Your opponent has " + coins
										+ " coins and you have " + opponent.coins + "!");
							}
						}
